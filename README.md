...
This is a fork of a Compose multiplatform template.I started by crawing the Google IO 2023 website
to get the sessions and speakers
and writing the data to a json file. You can find the
code [here](https://github.com/ngengesenior/crawlGoogleIO) which is written using
Python and BeautifulSoup 4.
The next on the plate is getting to parse the JSON file using Compose Multiplatform and rendering.
